...
PASSWORD = json.loads(conf.read())["db_password"]
...
class DBAccessor:
    # DB client
    def __init__(self):
        self.__client = pymongo.MongoClient(f"mongodb://ruben:{PASSWORD}@cluster0-shard-00-00.ely3j.mongodb.net:27017,cluster0-shard-00-01.ely3j.mongodb.net:27017,cluster0-shard-00-02.ely3j.mongodb.net:27017/?ssl=true&replicaSet=atlas-mh1otq-shard-0&authSource=admin&retryWrites=true&w=majority")
